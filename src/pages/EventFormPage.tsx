...
import { getEventById, getFamilyMembers, getPlaces } from "../data/repositories";
...
export function EventFormPage() {
  ...
  return (
    <div className="page-stack page-stack--form">
      ...
      <EventForm event={state.data.event} familyMembers={state.data.familyMembers} places={state.data.places} />
    </div>
  );
}
