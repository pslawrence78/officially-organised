...
export function SchoolCalendarPage() {
  ...
  return <div className="page-stack school-calendar-page">
    ...
    {calendar ? <>
      <section className="settings-links"><Link to="/settings/school-half-terms"><span className="secondary-navigation__icon"><Icon name="school" /></span><span><strong>Half-term requirements</strong><small>Lunch, uniform, PE and Forest School by date</small></span><Icon className="secondary-navigation__chevron" name="chevron" /></Link></section>
