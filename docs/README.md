...
| 09C | [Tranche 9C: Gifts and Celebrations Polish and Operational Fit v0.1](09C-gifts-and-celebrations-polish-and-operational-fit-v0.1.md) | Records the calm UX polish, readiness wording, empty-state improvements, mobile layout refinements, and deterministic celebration fixtures. | Implemented |
| 10A | [Tranche 10A: School Hub Consolidation v0.1](10A-school-hub-consolidation-v0.1.md) | Records the dedicated School Hub route, consolidated view-model, setup-gap surfacing, and navigation back to existing school configuration surfaces. | Implemented |
| 10B | [Tranche 10B: Household Admin and Renewals Foundation v0.1](10B-household-admin-and-renewals-foundation-v0.1.md) | Records the bounded household admin data model, due-state derivation, operational surfaces, local safety updates, and sync registration. | Implemented |
...
The application is implemented through **Tranche 10C**, including versioned local backup, validated transactional restore, protected reset, the landscape-first read-only Hub display polish, the optional Supabase foundation, the manual local-first sync engine and hardening UX, the bounded Gifts and Celebrations operational module, the dedicated School Hub consolidation surface, the bounded Household Admin and Renewals foundation, the safe Add Event to Create Routine bridge, and the shared mobile quick-capture and daily-use friction pass. Household Admin now covers practical due-date tracking for services and renewals without expanding into chores, budgeting, or document storage, and capture is now available as a lighter shell-level workflow across Event, Routine and Admin/Renewal. See documents 07, 07F, 08A, 08B, 08C, 09A, 09B, 09C, 10A, 10B, 10B.2, 10C and the Supabase configuration guide for the current boundary.
